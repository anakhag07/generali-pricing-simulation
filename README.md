...
profile. Slurm logs are written under `results/slurm/%x-%j.out`. Use
...
`results/glm-u-coef-sweep/u_coef_frontier_<timestamp>/`.
...
`results/glm-reference-elasticity-buckets/`.
