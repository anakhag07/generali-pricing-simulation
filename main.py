...
RUN_CONFIGS = ["real_data_glm_constant_policy_trust_region_constr"]  # List of config names to run, must be defined as a variable in the corresponding config module and included in the
