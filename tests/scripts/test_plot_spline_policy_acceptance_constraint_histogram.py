"""Tests for the spline acceptance-constraint histogram."""

from __future__ import annotations

import numpy as np

from scripts.plot_spline_policy_acceptance_constraint_histogram import (
    fixed_bins,
    histogram_frame,
)


def test_fixed_bins_have_expected_decimal_range() -> None:
    bins = fixed_bins()
...
def test_histogram_density_integrates_to_one() -> None:
    frame = histogram_frame(np.asarray([-0.1, -0.05, 0.0, 0.19, 0.2]))
